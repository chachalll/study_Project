...
public class Xzzc2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xzzc);
        myfind();
        recive();
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.button1:
                ...
                leib = myspin1.getSelectedItem().toString();

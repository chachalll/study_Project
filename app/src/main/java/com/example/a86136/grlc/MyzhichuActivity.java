...
public class MyzhichuActivity extends AppCompatActivity implements View.OnClickListener{
    String name;
    String mima;
    private Button myfh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myzhichu);
        recive();
        myfind();
        //find();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fh:
                ...
                break;
            case R.id.add:
                Intent intent3 = new Intent(this,Xzzc2Activity.class);
    ...
    public List<Come> findall(){
        ...
        Cursor cursor = db.rawQuery("select * from expend where name=?", new String[]{name});
    ...
    public List<Come> find(){
        SQLiteDatabase db = myHelper.getReadableDatabase();
        Cursor cursor;
        if(myleib.getText().toString().equals("")&&myintime.getText().toString().equals("")){
            cursor = db.rawQuery("select * from expend where name=?", new String[]{name});
        }
        else if(myleib.getText().toString().equals("")){
            cursor = db.rawQuery("select * from expend where name=? time=?", new String[]{name,myintime.getText().toString().trim()});
        }else{
            cursor = db.rawQuery("select * from expend where name=? leib=?", new String[]{name,myleib.getText().toString().trim()});
        }
    ...
    public  class Myadapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent){
            View view = View.inflate(MyzhichuActivity.this, R.layout.lv_item,null);
            ...
            mydelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(MyzhichuActivity.this,"删除成功！",Toast.LENGTH_SHORT).show();
            ...
            myupdate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent4 = new Intent(MyzhichuActivity.this,UpdateActivity.class);
    ...
    public void delete(String id) {
        SQLiteDatabase db = myHelper.getReadableDatabase();
        db.execSQL("delete from expend where _id=?",new String[]{id});
        db.close();
    }
}
